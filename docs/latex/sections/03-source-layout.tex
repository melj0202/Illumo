...
\pathref{IllEd/Source/}, \pathref{IllEd/Tests/} & World editor, document codec, and \texttt{IllEd.*} cases. \\
\pathref{IllMeshViewer/Source/}, \pathref{IllMeshViewer/Tests/} & Mesh viewer and \texttt{IllMeshViewer.*} cases. \\
\bottomrule
\end{tabularx}
\end{center}
