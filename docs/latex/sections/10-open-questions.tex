...
\begin{enumerate}
  ...
  \item \textbf{Linux/macOS:} invest now or freeze until token GL path is solid
        on Windows?
        \emph{Current status: Linux sources repaired for Ubuntu 24.04 x86_64
        X11/XWayland; still unsupported until native GUI smoke. macOS remains
        a scaffold. See \pathref{docs/packages/platform-linux.md}.}
