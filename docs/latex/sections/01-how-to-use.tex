...
\begin{statusbox}
As of 2026-09-14 (current-state audit): engine, scene, system, and platform code is
...
typed generational resources, managed texture/cubemap/shader assets, offscreen passes, painter-correct
